...
const transports = [
    ...
    new winston_1.default.transports.File({ filename: 'logs/error/mongodb.log', level: 'error', }),
    new winston_1.default.transports.File({ filename: 'logs/activity/all.log', level: 'info' }),
    new winston_1.default.transports.File({ filename: 'logs/activity/mongodb.log', level: 'info' }),
];
const mongoDBLogger = winston_1.default.createLogger({
    level: winston_vendors_1.level(),
    levels: winston_vendors_1.levels,
    format: winston_vendors_1.format,
    transports,
});
exports.default = mongoDBLogger;
