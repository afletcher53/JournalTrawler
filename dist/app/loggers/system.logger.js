...
const transports = [
    ...
    new winston_1.default.transports.File({ filename: 'logs/error/system.log', level: 'error' }),
    new winston_1.default.transports.File({ filename: 'logs/activity/all.log', level: 'info' }),
    new winston_1.default.transports.File({ filename: 'logs/activity/system.log', level: 'info' })
];
