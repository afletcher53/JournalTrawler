...
import { mongoCheckJournalExistsByISSN, mongoDeleteAllJournals, mongofetchJournalByISSN,
  mongoFindJournalById, mongoFindJournalByIdAndRemove, mongoFindJournalByIdAndUpdate, mongoFindJournalWhere, mongoSaveJournal } from '../requests/mongoose.service';
...
import { createErrorExists, createErrorExistsCrossRef} from '../validation/error.validation';
import {
